<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        else
        {
            ...
            {
                $insert="INSERT INTO tbl_customer (Customer_Id, Firstname, Lastname, Mobileno, Email, Password, Address, City,Status) VALUES ('NULL', '$firstName', '$lastName', '$mobileno', '$emailID', '$password', '$address', '$city','Activate')";
                if($insertResult= mysqli_query($con, $insert))
                {
                    ?><script>
                        swal({
                            title: "Regitered Successfully!",
                            text: "You are now member of our team!",
            ...
            <div class="card-body">
                <form action="#" method="post" name="registrationForm">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <b><label for="inputFirstName" class="form-label">First Name<span style="color: red;"> *</span></label></b>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <b><label for="inputLastName" class="form-label">Last Name<span style="color: red;"> *</span></label></b>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <b><label for="inputMobileNo" class="form-label">Mobile Number<span style="color: red;"> *</span></label></b>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <b><label for="inputEmailID" class="form-label">Email ID<span style="color: red;"> *</span></label></b>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <b><label for="inputAddress" class="form-label">Address<span style="color: red;"> *</span></label></b>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <b><label for="inputCity" class="form-label">City<span style="color: red;"> *</span></label></b>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <input style="padding-right:20px; padding-left: 20px;" class="btn btn-success my-sm-0" type="submit" value="SIGN UP">
                            </div>
                        </div>
                        <div class="col-md-6">
