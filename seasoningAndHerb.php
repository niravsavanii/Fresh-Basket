...
<div class="container-fluid">
    <div  class="row">
        <?php
            $select="SELECT distinct tbl_product_master.Product_Name,tbl_product_details.Quality,tbl_product_details.Image,tbl_product_details.Stock,tbl_product_details.Price,tbl_product_details.Description,tbl_product_details.Product_Detail_Id FROM tbl_product_details INNER JOIN tbl_product_master ON tbl_product_details.Product_Id=tbl_product_master.Product_Id WHERE tbl_product_master.Category='Seasoning and Herb' AND tbl_product_details.Status='1' GROUP BY tbl_product_master.Product_Name" ;
