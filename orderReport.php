...
<?php  
    if($_SERVER["REQUEST_METHOD"]=="POST")
    {
        ...
        $fromDate= date('Y-m-d', strtotime($_POST['fromDate'].' -1 day'));
    }
    else
    {
    ...
    $viewToDate=date('Y-m-d', strtotime($toDate.' -1 day'));
    $viewFromDate=date('Y-m-d', strtotime($fromDate.' +1 day'));
?>
<div class="row">
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <h4 style="text-align: center;"class="mr-left">Order's Report</h4>
                    </div>
                    <div class="col-md-5">
                        <form action="" method="POST">
                            <input type="date" style="background-color: #f2f2f2;width: 160px; margin-left: auto; float: left;" value="<?php echo $viewFromDate?>" name="fromDate" class="form-control">
                            <input type="date" style="background-color: #f2f2f2;width: 160px; margin-left: 10px; float: left;" value="<?php echo $viewToDate?>" name="toDate" class="form-control">
            ...
            <div class="card-body">
                <table id="datatable1" class="table table-bordered table-hover product-list">
                    <thead>
                        ...
                        <?php
                            //Get cart ID
                            $selectCartID="SELECT * FROM tbl_order where Insert_Date between '$fromDate' and '$toDate'";
