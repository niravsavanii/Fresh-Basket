        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-6">
                        <h4 style="text-align: center;"class="mr-left">List of all product</h4>
                    </div>
                    <div class="col-3">
            ...
            <div class="card-body">
                <table id="datatable1" class="table table-bordered table-hover product-list">
                    ...
                    <tbody>
                        <?php
                            $select="SELECT tbl_product_details.Product_Detail_Id,tbl_product_master.Product_Name,tbl_product_details.Image, tbl_product_details.Quality,tbl_product_details.Stock,tbl_product_details.Price,tbl_product_details.Description,tbl_product_details.Status,tbl_product_master.Category FROM tbl_product_details INNER JOIN tbl_product_master ON tbl_product_details.Product_Id=tbl_product_master.Product_Id";
