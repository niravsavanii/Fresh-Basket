...
if(isset($_POST['query']) && isset($_POST['category']))
{
    ...
    $output='';
    $query = "SELECT * FROM tbl_product_master WHERE Product_Name LIKE '".$_POST['query']."%' and Category='".$_POST['category']."' ORDER BY Product_Name ASC";
    ...
    {
        $output .='<li style="padding:7px;">Product not found</li>';
    }
    $output .='</ul>';
    echo $output;
}
