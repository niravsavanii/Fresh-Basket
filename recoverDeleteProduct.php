        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-6">
                        <h4 style="text-align: center;"class="mr-left">Temporary Deleted Product</h4>                        
                    </div>
                    <div class="col-1">                        
                    </div>
                    <div class="col-2">
            ...
            <div class="card-body">
                <table id="datatable1" class="table table-bordered table-hover product-list">
                    ...
                    <tbody>
                        <?php
                            $select="select * from tbl_product_master where Status=0";
                            if($result= mysqli_query($con, $select))
                            {
                                if(mysqli_num_rows($result)>0)
                                {
                                    while ($row= mysqli_fetch_array($result))
                                    {
                                        ...
                                        echo '<td><button type="button" class="btn btn-sm btn-info recoverDelete">Recover</button></td>';
                                        echo "</tr>";
                                    }
                                }
                            }
