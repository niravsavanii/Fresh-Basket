        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h4 style="text-align: center;"class="mr-left">Delivered Orders</h4>
                    </div>
                    <div class="col-md-3">
                    </div>
                </div>
            ...
            <div class="card-body">
                <table id="datatable1" class="table table-bordered table-hover product-list">
                    <thead>
                        ...
                        <?php
                            //Get cart ID
                            $selectCartID="SELECT tbl_order.*,tbl_delivery_boy.First_Name,tbl_delivery_boy.Last_Name FROM tbl_order INNER JOIN tbl_delivery_boy ON tbl_delivery_boy.Delivery_Boy_ID=tbl_order.Delivery_Boy_ID where tbl_order.Order_Status='Delivered'";
                                ...
                                {   
                                    if($count==1)
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;"  rowspan="<?php echo $numberOfProduct?>" scope="rowgroup"><?php echo $cartID[7].' '.$cartID[8]?></td>
